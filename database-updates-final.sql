...
-- 4. guest_book_relation_stats 테이블 (관계별 통계)
...
-- 5. public_guest_messages 테이블 (공개 메시지)
...
-- 9. 사용자-방명록 연결을 위한 뷰 (나중에 사용자가 가입할 때 활용)
