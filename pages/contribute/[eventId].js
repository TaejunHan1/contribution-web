...
export default function ContributePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen-mobile flex items-center justify-center" style={{background: 'var(--color-background-secondary)'}}>
        <div className="text-center">
          <div className="loading-spinner mx-auto mb-4"></div>
          <p className="text-body-2 text-gray-600">경조사 정보를 불러오는 중...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen-mobile flex items-center justify-center p-6" style={{background: 'var(--color-background-secondary)'}}>
        <div className="w-full max-w-md">
          <div className="card-toss text-center">
            ...
            <h1 className="text-title-1 text-gray-900 mb-4">경조사를 찾을 수 없습니다</h1>
            <p className="text-body-2 text-gray-600 mb-6">유효하지 않은 링크이거나 만료된 경조사입니다.</p>
            <button
              onClick={() => router.push('/')}
      ...
      <>
        ...
        <div className="min-h-screen-mobile flex items-center justify-center p-6" style={{background: 'var(--color-background-secondary)'}}>
          <div className="w-full max-w-md fade-in">
            <div className="card-toss text-center">
              <div className="icon-wrapper icon-primary mx-auto mb-6" style={{width: '80px', height: '80px', fontSize: '40px'}}>
                ✅
              </div>
              ...
              <div className="card-toss" style={{background: 'var(--color-gray-50)', border: 'none', marginBottom: '32px'}}>
                <div className="text-center">
                  <div className="text-caption-1 text-gray-600 mb-2">{eventInfo.amountLabel}</div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen-mobile" style={{background: 'var(--color-background-secondary)'}}>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h1 className="text-title-3 text-gray-900">{event.event_name}</h1>
            ...
            <div className="space-y-4">
              ...
              {event.location && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-body-1 text-gray-900">{event.location}</div>
                    {event.detailed_address && (
                      <div className="text-body-2 text-gray-600 mt-1">{event.detailed_address}</div>
                    )}
                  </div>
                </div>
              )}
              ...
              {event.event_type === 'funeral' && (
                <>
                  {event.funeral_home && (
                    <div className="flex items-center gap-3">
                      <span className="text-gray-500">🏥</span>
                      <span className="text-body-1 text-gray-900">{event.funeral_home}</span>
                    </div>
                  )}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="space-y-1">
                        {event.primary_contact && (
                          <div className="text-body-1 text-gray-900">{event.primary_contact}</div>
                        )}
                        {event.secondary_contact && (
                          <div className="text-body-1 text-gray-900">{event.secondary_contact}</div>
                        )}
                      </div>
                    </div>
                  )}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-8">
            ...
            <section className="fade-in" style={{animationDelay: '100ms'}}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  style={{
                    gridColumn: event.family_relations.length % 2 === 1 ? 'span 2' : 'auto'
                  }}
                >
                  선택 안함
                </button>
          ...
          <section className="fade-in" style={{animationDelay: '200ms'}}>
            ...
            {/* 직접 입력 */}
            <div className="card-toss" style={{background: 'var(--color-gray-50)', border: '2px solid var(--color-gray-200)'}}>
              <div className="text-center">
                ...
                <input
                  ...
                  style={{
                    ...
                    border: formData.useCustomAmount ? '2px solid var(--color-primary)' : 'none',
                    boxShadow: formData.useCustomAmount ? '0 0 0 3px rgba(49, 130, 246, 0.1)' : 'none'
                  }}
                />
              </div>
            </div>
          ...
          {event.allow_messages && (
            <section className="fade-in" style={{animationDelay: '300ms'}}>
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <label htmlFor="sendMessage" className="text-title-3 text-gray-900">
          ...
          <section className="fade-in" style={{animationDelay: '400ms'}}>
            <div className="card-toss" style={{background: 'linear-gradient(135deg, #3182F6 0%, #6366F1 100%)', color: 'white', border: 'none'}}>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-body-1 font-medium">{formData.contributorName || '미입력'}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-body-2 opacity-90">관계</span>
                  <span className="text-body-1 font-medium">{formData.relation || '선택 안함'}</span>
                </div>
                <div className="divider-toss" style={{background: 'rgba(255, 255, 255, 0.2)', margin: '16px 0'}}></div>
                <div className="flex justify-between items-center">
                  <span className="text-body-2 opacity-90">{eventInfo.amountLabel}</span>
                  <span className="amount-display" style={{color: 'white', fontSize: '24px'}}>
          ...
          <button
            ...
            className={`btn-toss w-full ${
              event.event_type === 'funeral' ? 'btn-funeral' : 
              event.event_type === 'wedding' ? 'btn-wedding' : 'btn-primary'
            } ${submitting ? 'disabled' : ''}`}
          ...
          >
            {submitting ? (
              ...
              event.event_type === 'funeral' ? '조의 전하기' : '부조하기'
            )}
          </button>
